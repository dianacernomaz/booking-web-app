...
public sealed class PropertyService(InMemoryAppStore store) : IPropertyService
{
    public IReadOnlyCollection<PropertySummaryDto> GetAllSummaries()
    {
        lock (store.SyncRoot)
        {
    ...
    public ServiceResult<PropertyDetailDto> GetById(int id)
    {
        lock (store.SyncRoot)
        {
    ...
    public IReadOnlyCollection<ManagedPropertyDto> GetByOwner(string ownerEmail)
    {
    ...
    public ServiceResult<ManagedPropertyDto> Create(UpsertPropertyRequestDto request)
    {
    ...
    public ServiceResult<ManagedPropertyDto> Update(int id, UpsertPropertyRequestDto request)
    {
        var validationError = Validate(request);
        if (validationError is not null)
        {
    ...
    public ServiceResult Delete(int id, string ownerEmail)
    {
