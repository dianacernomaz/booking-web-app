...
const Login: React.FC = () => {
    ...
    const validate = () => {
        ...
        else if (!/\S+@\S+\.\S+/.test(email)) e.email = 'Adresa de email nu este valida.';
        if (!password) e.password = 'Parola este obligatorie.';
        else if (password.length < 6) e.password = 'Parola trebuie sa aiba cel putin 6 caractere.';
        return e;
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(false);
        if (!result.ok) {
            setErrors({ general: result.error || 'Email sau parola incorecta.' });
            return;
        }
        setSubmitted(true);
            ...
            <div className="auth-page">
                <div className="auth-panel auth-panel--left">
                    <div className="auth-panel-content">
                        ...
                        <p>Conecteaza-te si continua sa explorezi mii de cazari din toata lumea.</p>
                        <ul className="auth-perks">
                            <li><span>✈️</span> Rezervari instantanee</li>
                            <li><span>❤️</span> Salveaza proprietati favorite</li>
                            <li><span>🔔</span> Notificari oferte exclusive</li>
                            <li><span>🛡️</span> Plati 100% securizate</li>
                        </ul>
                    </div>
                    ...
                    <div className="auth-form-wrap">
                        {submitted ? (
                            <div className="auth-success">
                                ...
                                <p>Esti conectat. Redirectionare...</p>
                            ...
                            <>
                                <div className="auth-header">
                                    <h1>Autentificare</h1>
                                    <p>Introdu datele contului tau StayBooker</p>
                                    <p style={{ fontSize: '0.85rem', color: '#64748b', marginTop: 8 }}>
                                        Admin demo: admin@booking.com / Admin123!
                                    </p>
                                </div>
                                ...
                                <form className="auth-form" onSubmit={handleSubmit} noValidate>
                                    ...
                                    <button type="submit" className="auth-btn" disabled={loading}>
                                        {loading ? <span className="auth-spinner" /> : 'Autentifica-te'}
                                    </button>
                                </form>
